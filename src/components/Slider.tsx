		...
		<ReactSlider {...settings}>
			{techStack.map((tech) => (
				<div key={tech.id} className="px-2 flex justify-center">
					<div className="flex justify-center items-center border border-gray-700 rounded-lg w-full max-w-[180px] h-12 bg-teal-800/20 hover:bg-teal-800/30 transition duration-300">
