...
export default function Contact() {
	return (
		<section className="py-20 bg-teal-800/20" id="contact">
			<div className="mx-auto px-8 max-w-3xl">
				...
				<div className="flex items-start justify-center space-x-20 border border-gray-700 py-6 px-7 rounded-lg">
					...
					<div className="h-full flex flex-col items-start justify-start text-white space-y-5">
						...
						<div className="flex items-center space-x-3">
							<FaGithub className="h-7 w-7 text-black bg-white rounded-full" />
						...
						<div className="flex items-center space-x-3">
							<FaLinkedin className="h-7 w-7 text-blue-500 bg-white rounded-sm" />
							<div className="flex flex-col items-start justify-center">
								<p>Linkedin</p>
								<span className="text-sm text-gray-400">
