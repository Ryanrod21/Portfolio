...
export default function Tech() {
	...
	return (
		<section className="py-20 bg-[#1e293b]" id="tech">
			<div className="container mx-auto px-6">
				...
				<div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl mx-auto bg-[#0f172a] border border-white/10 rounded-xl p-5 backdrop-blur">
					{/* Frontend */}
					<div>
						...
						<div className="grid grid-cols-2 gap-3">
							{frontendTech.map((tech) => (
								<div
									key={tech.id}
									className="flex items-center space-x-2 border border-gray-700 rounded-lg h-12 bg-[#334155] hover:bg-[#334155]/30 px-3"
								>
									{tech.icon}
