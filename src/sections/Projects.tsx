...
const filterButtons = [
	...
	{
		label: "HubSpot CMS",
		icon: <FaHubspot className="mr-2 text-orange-700" />,
		color: "orange",
	},
];
...
const colorMap: Record<string, { base: string; active: string }> = {
	...
	mongodb: {
		...
		active: "bg-gray-200 ring-2 ring-green-500",
	},
	white: {
		base: "bg-white hover:bg-gray-100",
		active: "bg-gray-200 ring-2 ring-black",
	},
	orange: {
		base: "bg-orange-500 hover:bg-orange-300",
		active: "bg-orange-500 ring-2 ring-white",
	},
};
